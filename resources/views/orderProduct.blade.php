                    ...
                    <div class="card-body">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <span>Subtotal:</span>
                                <span class="fw-bold">${{ number_format($ordershow->items->sum(fn($item) => $item->quantity * $item->product->price), 2) }}</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <span>Shipping:</span>
                                <span class="fw-bold">${{ number_format($ordershow->shipping, 2) }}</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <span>Tax (GST):</span>
                                <span class="fw-bold">${{ number_format($ordershow->tax, 2) }}</span>
                            </li>
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="fw-bold mb-0">Order Updates</h5>
                    </div>
                    ...
                    <div class="card-body text-center">
                        ...
                        <h5 class="mt-3 fw-bold">Shipping Status: <span
                        ...
                        @if ($ordershow->delivered_date && $ordershow->shipping_status == 'Delivered')
                            <form id="shipping-status-form" class="mt-4">
                                @csrf
                                <select class="form-select mb-2" name="shipping_status" required>
                        ...
                        @else
                            <p class="mt-3">When your order is delivered you can check and return your order</p>
                        @endif
                    </div>
                </div>
            </div>
