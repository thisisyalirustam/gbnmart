...
$(document).ready(function () {
    $("#addform").on("submit", function (e) {
        ...
        $.ajax({
            url: "/product-brand", //route for create
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
    ...
    $("#updateform").on("submit", function (e) {
        ...
        $.ajax({
            url: `/product-brand/${id}`, // The resource controller update route
...
update.addEventListener("show.bs.modal", function (event) {
    ...
    fetch(`/product-brand/${id}`, {
        ...
        .then((data) => {
            ...
            document.querySelector("#updateid").value = brand.id;
            document.querySelector("#updatename").value = brand.name;
        });
});
